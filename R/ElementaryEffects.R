...
#   na.rm:       whether to remove NA values before calculating statistics.
...
#
ElementaryEffects <- function(experiments, na.rm=TRUE, stats.only=TRUE) {
